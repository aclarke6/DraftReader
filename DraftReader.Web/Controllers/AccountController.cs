    ...
    ILogger<AccountController> logger) : Controller
{
    ...
    public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
    {
        ...
        if (user is not null && user.IsActive && !user.IsSoftDeleted)
        {
            ...
            var resetToken = DraftReader.Domain.Entities.PasswordResetToken.Create(model.Email);
            ...
            var body = $"""
                <p>You requested a password reset for your DraftReader account.</p>
            ...
            await emailSender.SendAsync(
                ...
                "Reset your DraftReader password",
                body);
        }
