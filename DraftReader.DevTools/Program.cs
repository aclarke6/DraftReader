...
// ---------------------------------------------------------------------------
// DraftReader DevTools - Scrivener project parser test harness
// ---------------------------------------------------------------------------
...
var tempDir = Path.Combine(Path.GetTempPath(), "DraftReaderPreview");
...
string BuildIndexPage(List<(string Title, string FilePath)> files)
{
    ...
    sb.AppendLine("<head>");
    sb.AppendLine("  <meta charset=\"UTF-8\">");
    sb.AppendLine("  <title>DraftReader Preview</title>");
    sb.AppendLine("  <style>");
    ...
    sb.AppendLine("</head>");
    sb.AppendLine("<body>");
    sb.AppendLine("  <h1>DraftReader - Scene Preview</h1>");
    sb.AppendLine("  <ul>");
