    ...
    IUnitOfWork unitOfWork) : INotificationService
{
    ...
    public async Task SendDigestAsync(Guid authorId, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            await emailSender.SendAsync(
                ...
                "DraftReader - New comments digest", body, ct);
    ...
    private static string GetSubject(EmailType emailType) => emailType switch
    {
        ...
        EmailType.CommentNotification       => "DraftReader - New comment on your manuscript",
        EmailType.ReplyNotification         => "DraftReader - New reply to your comment",
        EmailType.NewSectionNotification    => "DraftReader - New section available to read",
        EmailType.SectionChangedNotification => "DraftReader - A section has been updated",
        EmailType.DigestNotification        => "DraftReader - New comments digest",
        _                                   => "DraftReader notification"
    };
    ...
    private static string GetBody(EmailType emailType, Guid? relatedEntityId) => emailType switch
    {
        ...
        _                                => "You have a new notification on DraftReader."
    };
}
